...
if [ "$NEED_REBOOT" = "1" ]; then
    echo "***************************************************************"
    echo "  REBOOT FIRST, then start the commissioning tool:"
    echo ""
    echo "      sudo reboot"
    echo "      edgeconfig gui"
    echo ""
    echo "  /dev/ttyAMA3 only appears after the UART3 overlay is loaded,"
    echo "  and edgeconfig gui cannot scan the bus without it."
    echo ""
    echo "  Follow section 3.3 of the documentation (doc/index.html)."
    echo "***************************************************************"
else
    echo "Next: start the commissioning tool and follow section 3.3 of the"
    echo "documentation (doc/index.html):"
    echo ""
    echo "    edgeconfig gui"
fi
